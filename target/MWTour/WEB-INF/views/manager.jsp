...
<body>
	...
	<div>
		<form name="dropdownForm" id="dropdownForm" method="get" action="/MWTour/changeStatusManager">
		<input type="hidden" name="dropdownHidden" id="dropdownHidden" value="${statusSelected}" />
			<select id="tour_status" name="tour_status" >
				<option value="SUBMITTED">SUBMITTED</option>
				<option value="APPROVED">APPROVED</option>
				<option value="SUBMITFINANCE">SUBMIT for FINANCE</option>
			...
			<thead class="thead-inverse">
				<tr>
					...
					<th style="display: none;" data-field="local_convey">Local
						Conveyance</th>
					<th style="display: none;" data-field="approving_manager">Approving
						Manager</th>
			...
			<tbody>
				<c:forEach var="tours" items="${tours}">
					<tr data-toggle="modal" data-id="${tours.tour_id}"
						...
						<td style="display: none;">${tours.approving_manager}</td>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="padding: 40px 50px;">
					<form:form method="POST" action="/MWTour/managerSubmit"
						modelAttribute="tour" id="formModal">

						<form:hidden path="tour_id" value="${tour_id}" />
						<form:hidden path="approving_manager" />	
